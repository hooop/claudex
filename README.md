...
- Le débat s'écrit dans le terminal comme une sortie normale : le scroll, la sélection et le copier-coller restent ceux de ton émulateur, et rien de déjà affiché n'est jamais redessiné. La première intervention remplit l'écran depuis le haut tandis que la saisie reste en bas ; l'espace vide initial se résorbe ensuite et le renderer redevient un pied de page de sept lignes au plus. Les réponses Claude et Codex arrivent par vrais deltas. Commandes et outils sont résumés sur l'unique ligne de statut, sans leur sortie détaillée.
