...
- Le premier message reste provisoire jusqu'à sa qualification : un vrai non-sujet revient à l'accueil (`<<NO_TOPIC>>`), tandis qu'un sujet qui nécessite une précision attend l'humain (`<<WAIT_HUMAN>>`).
